...
3. **Real-Time:** P95 latency < 5s for critical data updates
...
> **See:** [Figure 4 — Human-AI Collaboration Loop](diagrams.md#4-solidai-human-ai-collaboration-loop) for complete interaction flow
